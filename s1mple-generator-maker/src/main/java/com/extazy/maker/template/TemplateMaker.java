package com.extazy.maker.template;
...
public class TemplateMaker {
    ...
    public static void main(String[] args) {
        ...
        String projectPath = System.getProperty("user.dir");
        String originProjectPath = new File(projectPath).getParent() + File.separator + "s1mple-generator-demo-projects/springboot-init";
        String inputFilePath1 = "src/main/java/com/extazy/springbootinit/common";
        String inputFilePath2 = "src/main/java/com/extazy/springbootinit/controller";
...
//        String searchStr = "Sum: ";
        ...
        long id = makeTemplate(meta, originProjectPath, templateMakerFileConfig, modelInfo, searchStr, 1840316301899640832L);
