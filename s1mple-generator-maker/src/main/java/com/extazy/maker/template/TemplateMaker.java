...
public class TemplateMaker {
    ...
    public static void main(String[] args) {
        ...
        modelInfoConfig1.setDefaultValue("jdbc:mysql://localhost:8101/my_db");
        modelInfoConfig1.setReplaceText("jdbc:mysql://localhost:8101/my_db");
...
//        String searchStr = "Sum: ";
        ...
        long id = makeTemplate(meta, originProjectPath, templateMakerFileConfig, templateMakerModelConfig, 1840316301899640832L);
